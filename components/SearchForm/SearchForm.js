...
import { setSearchKey, clearArticles } from 'services/reducers/articles/actions';
...
export default function SearchForm() {
    ...
    return (
        <form className={classes.vCenterForm} onSubmit={() => searchArticlesHandler(event)}>
            <div className={classes.inputGroup}>
                <input type="text" className={`form-control ${classes.formControl}`} {...searchKey} placeholder="Search what you want"/>
